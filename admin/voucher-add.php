...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($name) && !empty($code) && !empty($discount_value) && !empty($start_date) && !empty($end_date)) {
        $stmt = $pdo->prepare("INSERT INTO vouchers (name, code, discount_value, start_date, end_date) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute([$name, $code, $discount_value, $start_date, $end_date]);

        $success = "Thêm voucher thành công!";
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Thêm voucher mới</h4>
                    </div>
                    <div class="pb-20">
                        <form method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nhập tên voucher" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input type="number" class="form-control" id="discount_value" name="discount_value" placeholder="Nhập giá trị giảm" required />
                                </div>
                            </div>
