...
if (!$brand) {
    $error = "Không tìm thấy thương hiệu này.";
} else {
        ...
        if (isset($_FILES['logo']) && $_FILES['logo']['error'] === UPLOAD_ERR_OK) {
            ...
            if (!in_array($fileType, $allowedFileTypes)) {
                ...
                if (move_uploaded_file($fileTmpPath, $uploadPath)) {
                    ...
                    $stmt->execute([$brandName, $logoPath, $brandId]);
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    <div class="pd-20">
                        <h4 class="text-blue h4">Cập nhật thương hiệu mới</h4>
                    </div>
                    <div class="pb-20">
                        <form method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input type="text" class="form-control" id="BrandName" name="BrandName" value="<?= htmlspecialchars($brand['name']) ?>" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    ...
                                    <div>
                                        <img src="<?= $brand['logo'] ?>" alt="Logo cũ" width="100" class="mt-2">
                                    </div>
                                </div>
                            </div>
